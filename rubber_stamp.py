...
def python_tt_rubber_stamp(image, layer, distress_file, font, top_text, middle_text, bottom_text, invert, merge, leave_mask):
	...
	#loads distress image and copy it
	distress_img = pdb.file_png_load(distress_file,distress_file)
...
register(
	...
	"RGB*, GRAY*", 
	[
	(PF_FILE, "distress_file", "distress .png file:", 0),
