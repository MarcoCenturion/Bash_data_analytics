...
class reproductor:
    def __init__(self):
        ...
        layout = [sg.Button(button_text="Seleccionar Carpeta", key="carpeta"), 
        sg.Button(button_text="Seleccionar Cancion", key="cancion")],
        [sg.Image(filename='logo_avion.png', key='-image-')],
